...
export default function Dashboard() {
    ...
    const confirmDelete = async () => {
        ...
        try {
            await fetch(`${API_URL}/api/documents/${docToDelete.docId}`, { method: 'DELETE' });
    ...
    // ... (existing code, replace deleteDocument usage in JSX)
                    ...
                    >
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-2 bg-red-500/10 text-red-500 border border-red-500/20 rounded-lg font-medium hover:bg-red-500/20 transition-colors"
                            >
                                Delete
                            </button>
                        </div>
